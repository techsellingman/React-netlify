...
import { locationlist, statuslist, pricerangelist, bedslist, bathroomslist, environmentlist, housearealist, landarealist} from '../../data/select.json';
                            ...
                            <div className="acr-filter-form">
                                <form>
                                    ...
                                    <div className="acr-custom-select form-group">
                                        ...
                                        <Select2 data={environmentlist} options={{
                                    ...
                                    <div className="acr-custom-select form-group">
                                        ...
                                        <Select2 data={housearealist} options={{
                                            placeholder: 'Any House Area',
                                        }} />
                                    </div>
                                    <div className="acr-custom-select form-group">
                                        <label>Land Area: </label>
                                        <Select2 data={landarealist} options={{
